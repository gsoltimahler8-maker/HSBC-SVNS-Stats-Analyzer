...
function App(){
  ...
  return <div className="app">
    ...
    <main className="grid">
      ...
      <section className="panel wide"><h2>Win/Loss comparison</h2><p className="note">分析条件を固定した上で、勝利試合と敗戦試合の平均値を比較します。</p><div className="chart"><ResponsiveContainer width="100%" height={320}><BarChart data={analysisRows}><CartesianGrid strokeDasharray="3 3"/><XAxis dataKey="metric"/><YAxis/><Tooltip/><Legend/><Bar dataKey="wins" name="Wins avg"/><Bar dataKey="losses" name="Losses avg"/></BarChart></ResponsiveContainer></div></section>
