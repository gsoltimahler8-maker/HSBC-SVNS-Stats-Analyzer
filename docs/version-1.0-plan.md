...
Version1.0では、公開に必要な情報整備に加えて、当初ロードマップで予定していたPWA化と出力機能を実装する。
...
当初ロードマップでVersion1.0に予定していた出力機能を実装する。

- Match Searchの表示内容をCSV出力
- Match Searchの表示内容をExcel出力
- 試合詳細または比較結果をPDF出力
- 日本語／英語の出力確認
- ファイル名ルール
- 出典・取得日時・dataCoverageLevelの付記
- スマートフォンでの出力動作確認
