...
# Version1.1 Roadmap — Architecture, Handover and World Rugby Readiness

Version: v1.1  
Status: Planned  
Revision: Architecture / Handover priority  
Created: 2026-07-26  
...
Version1.1は、Version1.0で完成した初期MVPを維持しながら、World Rugbyまたは同等の組織が次のいずれを選んでも扱いやすい状態へ整える工程とする。
...
World RugbyがReact、GitHub Pages、現在のデータ形式を採用しない場合でも、次が再利用できる状態を目指す。
...
- analysis calculation unit test
- normalization test
...
Architecture、Security、Provider、Schema、Testの完了後に行う。
...
SchemaとData Dictionaryが整備されている
